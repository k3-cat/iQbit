...
type settingsPageNames = "Download" | "Connection" | "Speed" | "BitTorrent" | "RSS" | "Web UI" | "Advanced";
...
const SettingsHeader = ({ title, onBackButtonPress }: { title: string; onBackButtonPress?: () => void }) => {
