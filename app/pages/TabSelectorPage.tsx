...
const TabSelectorPage = () => {
	...
	const [tabs, setTabs] = useLocalStorage<(PageLabels | "")[]>("tabs", ["Search", "Trending"]);
	...
	return (
		<Flex flexDirection="column" gap={4}>
			{Pages.map((page) => {
				...
				return (
					<Flex key={page.url} py={3} pl={5} pr={3} rounded="lg" bgColor={bgColor} alignItems="center">
			...
			<SimpleGrid left={0} width="100vw" columns={4} textAlign="center" gap={2} position="fixed" bottom={24}>
				<span />
