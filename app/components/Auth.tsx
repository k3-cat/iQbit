...
import { Box, Button, FormControl, FormErrorMessage, Heading, useColorModeValue, VStack } from "@chakra-ui/react";
...
export const AuthChecker = () => {
	...
	const { isSuccess: isWhiteListed } = useQuery("versionCheck", TorrClient.getVersion, { retry: false });
